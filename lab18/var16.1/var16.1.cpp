...
int main()//объявляем главную функцию
{
	...
	FILE* fileA = fopen("/Денис/лабы по оаипу/labs/Файлы для 18лр/fileA1.txt", "r");
	if (fileA == NULL) {
	...
	FILE* fileB = fopen("/Денис/лабы по оаипу/labs/Файлы для 18лр/fileB1.txt", "r");
	if (fileB == NULL) {
	...
	FILE* fileC = fopen("/Денис/лабы по оаипу/labs/Файлы для 18лр/fileC1.txt", "w");
	if (fileC == NULL) {
