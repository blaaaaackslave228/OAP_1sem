...
int main()//объявляем главную функцию
{
	...
	FILE* fileA = fopen("/Денис/лабы по оаипу/labs/Файлы для 18лр/NameA.txt", "r");
	if (fileA == NULL) {
	...
	FILE* fileB = fopen("/Денис/лабы по оаипу/labs/Файлы для 18лр/NameB.txt", "r");
	if (fileB == NULL) {
	...
	FILE* fileC = fopen("/Денис/лабы по оаипу/labs/Файлы для 18лр/NameC.txt", "r");
	if (fileC == NULL) {
	...
	FILE* fileD = fopen("/Денис/лабы по оаипу/labs/Файлы для 18лр/NameD.txt", "w");
	if (fileD == NULL) {
